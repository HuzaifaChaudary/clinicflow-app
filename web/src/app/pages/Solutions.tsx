...
export function Solutions() {
  ...
  const clinicContent = {
    'mental-health': {
      ...
      subtext: 'Appointment confirmations, reminders, and intake happen quietly in the background so staff can focus on care, not chasing responses.',
    ...
    'physiotherapy': {
      ...
      subtext: 'Recurring sessions, reminders, and follow ups stay on track automatically so therapists focus on recovery, not rescheduling.',
    ...
    'dental': {
      ...
      subtext: 'Confirmations, reminders, and follow ups happen automatically so chair time stays protected and schedules stay tight.',
