        ...
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              Admin enters basic information once. The system applies these rules automatically every day.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)]">
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              After setup, this happens automatically for every appointment. No manual work required.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)]">
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              The system handles every response automatically. Staff only step in when needed.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-[var(--foreground-muted)] mb-8">
                Patients receive intake forms automatically after booking. Doctors see a clear summary before the session starts.
              </p>
            ...
            {[
              {
                icon: Settings,
                role: 'For admins',
                description: 'Configure clinic rules once. System follows them automatically. Override when needed. Never lose control.'
              },
              {
                icon: User,
                role: 'For doctors',
                description: 'Show up to appointments. See clear context. Start sessions prepared. Focus on care, not logistics.'
              },
              {
                icon: Calendar,
                role: 'For patients',
                description: 'Book appointments anytime. Get clear confirmations. Know what to bring. Show up prepared.'
              }
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <div className="max-w-[720px] mx-auto p-10 rounded-3xl" style={{ backgroundColor: '#EAF1FF' }}>
                ...
                >
                  Talk to us first
                  <span style={{ transition: 'all 200ms ease-out' }}>→</span>
                </Link>
              </div>
            </motion.div>
          </div>
