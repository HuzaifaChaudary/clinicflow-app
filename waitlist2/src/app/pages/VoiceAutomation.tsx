  ...
  const conversationSteps: ConversationFlowStep[] = [
    {
      ...
      outcome: {
        ...
        description: 'System executes voice call automatically 24-48 hours before appointment with clear ownership. No staff involvement required.',
        metric: '24-48h'
      }
    },
    {
    ...
    },
    {
      ...
      outcome: {
        ...
        description: 'System records confirmation immediately with full tracking. Schedule updates in real-time. Staff sees current status without making calls.',
        metric: 'Real-time'
      }
    },
    {
      ...
      outcome: {
        ...
        description: 'Confirmation flows to scheduling system with clear execution. No manual data entry. No phone tag. No missed updates.',
        metric: 'Instant sync'
      }
    },
    {
      ...
      outcome: {
        ...
        description: 'Cancellations happen 24-48 hours early with clear visibility. Clinic has time to fill slot. Revenue protected.',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative">
            ...
            >
              ...
              <p className="text-2xl mb-8">
                Axis executes voice confirmations and reschedules automatically with clear ownership—so your front desk can focus on in-person patients.
              </p>
              <p className="text-xl text-[var(--foreground-muted)]">
                Text reminders get ignored. Voicemails go unchecked. Phone calls from the clinic get returned. Voice confirmations work because patients take them seriously and clinics get full tracking.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)] bg-gradient-to-b from-[var(--background)] to-[var(--background-secondary)]">
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              Watch the conversation unfold. Each step executes automatically with clear ownership.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: 'Patients can reschedule during the call with full visibility. No back-and-forth texts. No waiting for staff availability.'
                }
              ].map((item, index) => (
                <motion.div
                  key={index}
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)] bg-[var(--background-secondary)]">
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            >
              Voice confirmations execute work automatically with clear tracking. They free up staff time, fill more appointment slots, and create better patient accountability—without hiring more people.
            </motion.p>
          </div>
        </div>
      </section>
