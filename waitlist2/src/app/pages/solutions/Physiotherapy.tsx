          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-2xl text-[var(--foreground-muted)] mb-12">
                Recurring sessions, reminders, and follow ups execute on track automatically with full visibility so therapists focus on recovery.
              </p>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)]">
        <div className="max-w-[1400px] mx-auto px-8">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: flowEasing }}
          >
            <h2 className="mb-8">Consistency built into every step</h2>
            <p className="text-xl text-[var(--foreground-muted)]">
              Physiotherapy care happens over weeks, not once. Axis manages recurring schedules and communication with clear ownership so patients stay consistent without staff chasing them.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)]">
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              Admins configure rules once. Axis handles confirmations, reschedules, and follow ups automatically with clear visibility. Staff only step in for exceptions.
            </p>
          </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8, ease: flowEasing }}
            >
              <h2 className="mb-8">Built to support recovery journeys</h2>
              <p className="text-xl text-[var(--foreground-muted)]">
                Axis supports high frequency visits, therapist schedules, and patient follow through with clear execution without adding operational noise.
              </p>
            </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8, ease: flowEasing }}
            >
              <h2 className="mb-6">Support consistency without extra work</h2>
              <p className="text-xl text-[var(--foreground-muted)] mb-12">
                See how Axis works for physiotherapy clinics.
              </p>
