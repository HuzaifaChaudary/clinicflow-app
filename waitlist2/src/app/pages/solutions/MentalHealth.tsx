          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-2xl text-[var(--foreground-muted)] mb-12">
                Appointment workflows execute quietly in the background with clear ownership so staff can focus on care without chasing responses.
              </p>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)] bg-[var(--background-secondary)]">
        <div className="max-w-[1400px] mx-auto px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              Patients receive clear confirmations and reminders before their session with full tracking. They can confirm or reschedule without calling the clinic. Staff are only involved when something needs attention.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)] bg-[var(--background-secondary)]">
        <div className="max-w-[1400px] mx-auto px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              Admins set communication rules once. Axis executes daily operations automatically with clear ownership. Staff step in only when a patient needs support or a session changes.
            </p>
          </motion.div>
