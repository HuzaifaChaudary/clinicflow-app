...
export function Dental() {
  ...
  const workflowSteps = [
    ...
    { label: 'Execute', detail: 'System runs automatically', icon: CheckCircle },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-2xl text-[var(--foreground-muted)] mb-12">
                Confirmations, reminders, and follow ups execute automatically with clear tracking so chair time stays protected and schedules stay tight.
              </p>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)]">
        <div className="max-w-[1400px] mx-auto px-8">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: flowEasing }}
          >
            <h2 className="mb-8">Predictable operations for fast schedules</h2>
            <p className="text-xl text-[var(--foreground-muted)]">
              Dental clinics depend on predictable schedules. Axis confirms visits, sends reminders, and follows up with clear tracking so chairs stay filled without staff chasing patients.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)] bg-[var(--background-secondary)]">
        <div className="max-w-[1400px] mx-auto px-8">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: flowEasing }}
          >
            <h2 className="mb-8">Treatment plans that stay on track</h2>
            <p className="text-xl text-[var(--foreground-muted)]">
              Follow up visits and procedures stay visible to patients with clear ownership. Axis prompts next steps so treatment plans move forward naturally.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)] bg-[var(--background-secondary)]">
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              Admins configure rules once. Axis executes confirmations, reminders, and follow ups automatically with full visibility. Staff step in only when needed.
            </p>
          </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8, ease: flowEasing }}
            >
              <h2 className="mb-8">Designed for fast, tight schedules</h2>
              <p className="text-xl text-[var(--foreground-muted)]">
                Axis supports fast paced schedules, repeat visits, and patient follow through with clear execution without disrupting how clinics already work.
              </p>
            </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8, ease: flowEasing }}
            >
              <h2 className="mb-6">Keep chairs filled without extra effort</h2>
