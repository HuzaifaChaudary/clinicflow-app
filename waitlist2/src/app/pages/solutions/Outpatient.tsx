          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-2xl text-[var(--foreground-muted)] mb-12">
                Axis keeps outpatient schedules flowing with clear execution. Confirmations, reminders, and intake happen automatically so staff can focus on patients.
              </p>
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              Outpatient clinics succeed when patient movement stays predictable. Axis stabilizes schedules with clear tracking by confirming visits, preparing patients, and reducing last minute uncertainty.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)] bg-[var(--background-secondary)]">
        <div className="max-w-[1400px] mx-auto px-8">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: flowEasing }}
          >
            <h2 className="mb-8">Confirmations at scale</h2>
            <p className="text-xl text-[var(--foreground-muted)]">
              Axis confirms appointments automatically across SMS and voice with full visibility. Patients respond quickly. Staff does not chase responses.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)]">
        <div className="max-w-[1400px] mx-auto px-8">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: flowEasing }}
          >
            <h2 className="mb-8">Different visits need different timing</h2>
            <p className="text-xl text-[var(--foreground-muted)]">
              Short consults, procedures, and follow ups each follow different reminder logic with clear execution. Axis adapts automatically.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)]">
        <div className="max-w-[1400px] mx-auto px-8">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: flowEasing }}
          >
            <h2 className="mb-8">Walk ins stay manageable</h2>
            <p className="text-xl text-[var(--foreground-muted)]">
              Axis absorbs walk ins by maintaining clarity around confirmed, pending, and flexible slots with full visibility.
            </p>
          </motion.div>
      ...
      <section className="relative py-32 border-t border-[var(--glass-border)] bg-[var(--background-secondary)]">
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          >
            ...
            <p className="text-xl text-[var(--foreground-muted)]">
              Admins set rules once. Axis enforces confirmations, reminders, and follow ups automatically with clear ownership. Staff intervene only when exceptions occur.
            </p>
          </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8, ease: flowEasing }}
            >
              <h2 className="mb-8">Supports clinic operations at scale</h2>
              <p className="text-xl text-[var(--foreground-muted)]">
                Axis does not replace systems. It provides the execution and operations layer that keeps clinics running smoothly at scale.
              </p>
            </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-8">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8, ease: flowEasing }}
            >
              <h2 className="mb-6">Stay ahead without breaking flow</h2>
