      ...
      <TheInfiniteGrid className="min-h-screen">
        <section className="relative pt-32 pb-40">
          <div className="max-w-[1400px] mx-auto px-8">
            ...
            >
              <h1 className="mb-8">Where clinic operations actually get done</h1>
              <p className="text-2xl text-[var(--foreground-muted)] mb-12">
                Axis is an AI‑first execution system that handles appointments, follow‑ups, and operational workflows. Your clinic owns the process. The system ensures nothing falls through.
              </p>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-[var(--foreground-muted)]">
                Axis works alongside your existing systems. It does not replace them. System‑driven workflows handle operational tasks so your clinic runs smoother without extra staff or tools.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="mb-20">
            ...
            >
              ...
              <p className="text-xl text-[var(--foreground-muted)] max-w-3xl">
                Every clinic day follows the same pattern. Appointments. Patients. Paperwork. Follow ups. Axis supports each step with clear ownership and follow‑through.
              </p>
            </motion.div>
          </div>
