...
export function Pricing() {
  ...
  const automationNodes = [
    { icon: Calendar, label: 'Appointments scheduled', detail: 'System tracks availability automatically with clear ownership' },
    { icon: Phone, label: 'Confirmations sent', detail: 'Voice calls execute 24-48 hours before with full tracking' },
    { icon: CheckCircle, label: 'Responses handled', detail: 'Confirms, reschedules, no-shows processed automatically' },
    { icon: Users, label: 'Staff only step in when needed', detail: 'Exceptions routed with clear visibility' }
  ];
  ...
  const pricingTiers = [
    {
      ...
      features: [
        'Appointment confirmations with tracking',
        'Voice or SMS execution',
    ...
    },
    {
      ...
      features: [
        'Voice + SMS automation with full visibility',
        'Rule based rescheduling with ownership',
    ...
    },
    {
      ...
      features: [
        ...
        'Advanced routing rules with clear ownership',
        'Volume pricing',
  ...
  const roiStats = [
    { value: '40–60%', label: 'fewer no-shows' },
    { value: '8–12 hours', label: 'saved weekly at front desk' },
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes. You can start with SMS workflows and add voice confirmations later. The system adapts to your preferences with clear execution tracking.'
    },
    {
      question: 'Does this replace our EHR?',
      answer: 'No. Axis works alongside your existing EHR. It executes operational workflows like scheduling and communication with clear ownership, not clinical records.'
    },
    {
      question: 'How long does setup take?',
      answer: 'Initial setup is designed for fast completion without disrupting clinic operations. Enter clinic hours, workflow rules, and communication preferences. The system executes the rest automatically with full visibility.'
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-2xl text-[var(--foreground-muted)] mb-12">
                Pay for what executes automatically with clear ownership.<br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-[var(--foreground-muted)] mb-6">
                Pricing is based on workflow volume and automation execution, not staff seats.
              </p>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-[var(--foreground-muted)] mb-12">
                A short walkthrough of real clinic workflows with clear ownership.<br />
